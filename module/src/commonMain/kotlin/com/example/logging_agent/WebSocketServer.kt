...
import com.example.logging_agent.model.GraphData
import com.example.logging_agent.model.JsonData
import com.example.logging_agent.model.LogMessage
     ...
     fun run() {
        try {
            ...
            while (isRunning) {
                ...
                mRequestHandler = WebSocketHandler(sessionDetails, socketCallback)
